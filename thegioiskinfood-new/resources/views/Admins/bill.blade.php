                    ...
                    <div class="tab_bill_item">
                        <ul class="nav nav-tabs flex-column flex-sm-row">
                            ...
                            <li class="nav-item m-2">
                                <a class="nav-link {{ Request::routeIs('admin.bill') ? 'active' : '' }}" href="{{ route('admin.bill') }}">

                                    <span class="text">Chờ Xác Nhận</span>
                                </a>
                            </li>
                            <li class="nav-item  m-2">
                                <a class="nav-link {{ Request::routeIs('admin.delivering') ? 'active' : '' }}" href="{{ route('admin.delivering') }}">

                                    <span class="text">Đang Giao Hàng</span>
                                </a>
                            </li>
                            <li class="nav-item  m-2">
                                <a class="nav-link {{ Request::routeIs('admin.reserved') ? 'active' : '' }}" href="{{ route('admin.reserved') }}">

                                    <span class="text">Đã Nhận Hàng</span>
                                </a>
                            </li>
                            <li class="nav-item  m-2">
                                <a class="nav-link {{ Request::routeIs('admin.canceled') ? 'active' : '' }}" href="{{ route('admin.canceled') }}">
